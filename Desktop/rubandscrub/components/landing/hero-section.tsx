      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          >
            <motion.div
              variants={fadeInUp}
              className="inline-flex rounded-full border border-white/20 bg-white/10 px-4 py-2 text-sm font-medium text-white shadow-sm backdrop-blur-sm"
            >
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="grid gap-4 text-sm text-gray-600 sm:grid-cols-3"
            >
